        ...
        <div class="row">
            ...
            <div class="col-md-9 pleft37">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <br>
                        <p>Укажите в личном профайле варианты, которые вы можете предложить друзьям – угостить чашкой кофе и пообщаться; предоставить диван, чтобы переночевать или организовать прогулку. Заполняя приглашения, оставьте как можно больше значимой информации о себе. Чем уникальнее и точнее вы опишите свои интересы, тем вероятнее, что вы встретите более привлекательного именно для вас гостя.</p>
                    </div>
                </div>
                @if (Auth::check())
                <div class="row">
